...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand fw-bold text-light fs-4 ms-4" href="/admin">
    ...
    <div class="side-bar">
        ...
        <div class="menu">
            <div class="item">
                ...
                <a href="/admin"><i class="fas fa-desktop"></i>Dashboard</a>
                <hr class="bg-secondary" />
            </div>
            <div class="item">
                <a class="sub-btn"><i class="fas fa-table"></i>Tables<i class="fas fa-angle-right dropdown"></i></a>
                <div class="sub-menu">
                    <a href="/admin/buku" class="sub-item"><i class="fas fa-book-open me-2"></i> Buku</a>
                    <hr class="bg-secondary" />
                    <a href="/admin/anggota" class="sub-item"><i class="fas fa-users me-2"></i> Anggota</a>
                    <hr class="bg-secondary" />
                    <a href="/admin/petugas" class="sub-item"><i class="fas fa-users-cog me-2"></i> Petugas</a>
                    <hr class="bg-secondary" />
                    <a href="/admin/rak" class="sub-item"><i class="fas fa-archive me-2"></i> Rak</a>
                </div>
            </div>
            <hr class="bg-secondary" />
