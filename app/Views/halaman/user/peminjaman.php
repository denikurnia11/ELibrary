...
<div class="row text-start">
    ...
    <?php endif; ?>
    <div class="col-8">
        <a href="/user/peminjaman/tambah" class="btn btn-primary mb-2"><i class="fas fa-plus"></i> Peminjaman Buku</a>
            ...
            <tr>
                ...
                <?php if (session()->idUser === $row['id_anggota']) : ?>
                    <td class="text-center">
                        <a href="/user/peminjaman/edit/<?= $row['id_pinjam']; ?>" class="btnAction btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                    </td>
                <?php else : ?>
